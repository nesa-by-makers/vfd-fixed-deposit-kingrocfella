    ...
    <?php
            ...
            while($row = $fdquery->fetch_assoc()){
              ...
              while ($rowpayout = $payquery->fetch_assoc()){
                echo "<td>".$rowpayout['AccNamePayout']."</td><td>".$rowpayout['BankNamePayout']."</td><td>".$row['AccountingOfficer']."</td><td> <a href='supdbinsert.php?id=".$row['ID']."&verified=verified'>Verify</a></td></tr>";
